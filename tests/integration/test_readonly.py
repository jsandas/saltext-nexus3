...
def test_describe_readonly():
    ...
    assert ret["test.minion"]["read-only"]["frozen"] is False, "read-only should be disabled"
...
def test_enable_readonly():
    ...
    # print(ret)
    assert ret["test.minion"]["read-only"] != {}, "read-only is empty"
    assert ret["test.minion"]["read-only"] is True, "read-only should be enabled"
...
def test_disable_readonly():
    ...
    # print(ret)
    assert ret["test.minion"]["read-only"] != {}, "read-only is empty"
    assert ret["test.minion"]["read-only"] is False, "read-only should be disabled"
